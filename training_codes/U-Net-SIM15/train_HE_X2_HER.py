...
import sys
path = '/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_HER/'
    ...
    for epoch in range(2000):
        ...
        for i,p in enumerate(loss_all):
            for j,q in enumerate(p):
                table.write(i,j,q)
        file.save('/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_HER/loss_HE_X2_HER_0901.xls')
        ...
        torch.save(model.state_dict(), "/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_HER/HE_X2_HER_0901.pkl")
