...
import sys
path = '/pine/scr/l/h/lhjin/SRRF/Code/microtubule/SRRF_in5/'
...
if __name__ == "__main__":
    ...
    input_size = 5
    output_size = 1
    SRRFDATASET = ReconsDataset(all_data_path="/pine/scr/l/h/lhjin/SRRF/Dataset_MTs_npy/",
                                maximum_intensity_4normalization_path="/pine/scr/l/h/lhjin/SRRF/Code/microtubule/SRRF_in10/Max_intensity.npy",
                                transform = ToTensor(),
    ...
    SRRFDATASET2 = ReconsDataset(all_data_path="/pine/scr/l/h/lhjin/SRRF/Dataset_MTs_npy/",
                                maximum_intensity_4normalization_path="/pine/scr/l/h/lhjin/SRRF/Code/microtubule/SRRF_in10/Max_intensity.npy",
                                transform = ToTensor(),
    ...
    for epoch in range(2000):
        ...
        for i,p in enumerate(loss_all):
            for j,q in enumerate(p):
                table.write(i,j,q)
        file.save('/pine/scr/l/h/lhjin/SRRF/Code/microtubule/SRRF_in5/loss_SRRF_in5_0908.xls')
        ...
        if epoch % 50 == 49:
            torch.save(model.state_dict(), "/pine/scr/l/h/lhjin/SRRF/Code/microtubule/SRRF_in5/SRRF_in5_"+str(epoch+1)+".pkl")
