...
import sys
path = '/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_3f_HER/'
...
if __name__ == "__main__":
    ...
    SRRFDATASET = ReconsDataset(train_in_path="/pine/scr/l/h/lhjin/SIM/Dataset/microtubule/training/HE_X2/",
                                train_gt_path="/pine/scr/l/h/lhjin/SIM/Dataset/microtubule/training/HER/",
                                transform = ToTensor(),
                                img_type = 'tif',
                                in_size = 256)
    ...
    SRRFDATASET2 = ReconsDataset(train_in_path="/pine/scr/l/h/lhjin/SIM/Dataset/microtubule/testing/testing_HE_X2/",
                                train_gt_path ="/pine/scr/l/h/lhjin/SIM/Dataset/microtubule/testing/testing_HER/",
                                transform = ToTensor(),
                                img_type = 'tif',
                                in_size = 256)
    ...
    for epoch in range(2000):
        ...
        for i,p in enumerate(loss_all):
            for j,q in enumerate(p):
                table.write(i,j,q)
        file.save('/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_3f_HER/loss_HE_X2_3f_HER_0825.xls')
        ...
        torch.save(model.state_dict(), "/pine/scr/l/h/lhjin/SIM/microtubule/HE_X2_3f_HER/HE_X2_3f_HER_0901.pkl")
