...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 19:32:23 2019
    ...
    for epoch in range(2000):
        ...
        for i,p in enumerate(loss_all):
            for j,q in enumerate(p):
                table.write(i,j,q)
        file.save('/home/star/0_code_lhj/DL-SIM-github/Training_codes/UNet/loss_UNet_SIM4_microtubule.xls')
        ...
        torch.save(model.state_dict(), "/home/star/0_code_lhj/DL-SIM-github/Training_codes/UNet/UNet_SIM4_microtubule.pkl")
