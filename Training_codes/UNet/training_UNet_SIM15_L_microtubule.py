...
#    print(intensity_v['max_out'])
    ...
    SRRFDATASET2 = ReconsDataset(train_in_path="/media/star/LuhongJin/UNC_data/SIM/ALL_data/microtubule/Training_Testing/testing_LE_X2/",
    ...
    for epoch in range(2000):
        ...
        for i,p in enumerate(loss_all):
            for j,q in enumerate(p):
                table.write(i,j,q)
        file.save('/home/star/0_code_lhj/DL-SIM-github/Training_codes/UNet/UNet_SIM15_L_microtubule.xls')
