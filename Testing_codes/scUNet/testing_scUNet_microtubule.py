...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 16:28:05 2019
...
#import sys
#path = '/home/star/0_code_lhj/DL-SIM-github/Testing_codes/scUNet/'
...
if __name__ == "__main__":
    ...
    model.cuda(cuda)
    model.load_state_dict(torch.load("/home/star/0_code_lhj/DL-SIM-github/MODELS/scUNet_microtubule.pkl"))
    model.eval()
    ...
    for batch_idx, items in enumerate(test_dataloader):
        ...
        max_out = 15383.0
        pred = pred*max_out
        io.imsave('/home/star/0_code_lhj/DL-SIM-github/Testing_codes/scUNet/prediction/' +image_name[0] + '_pred.tif', pred.detach().cpu().numpy().astype(np.uint32))
